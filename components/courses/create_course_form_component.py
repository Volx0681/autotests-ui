...
class CreateCourseFormComponent:
    def __init__(self, page: Page):
        self.title_input = page.locator('[data-testid="course-title-input"] input')
        self.time_input = page.locator('[data-testid="course-estimated-time-input"] input')
        self.description_input = page.locator('[data-testid="course-description-input"] textarea')
        self.max_score_input = page.locator('[data-testid="course-max-score-input"] input')
        self.min_score_input = page.locator('[data-testid="course-min-score-input"] input')
    ...
    def check_visible(self, title: str = None, estimated_time: str = None,
                      description: str = None, max_score: str = None, min_score: str = None):
